...
const sampleImages = [
  ...
  "https://images.pexels.com/photos/14772068/pexels-photo-14772068.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2",
...
export function Library() {
  ...
  const handleImageSelect = (imageUrl: string) => {
    ...
    setSelectedImageUrl(selectedImageUrl === imageUrl ? '' : imageUrl);
  };
